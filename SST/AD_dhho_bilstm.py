...
from attack_dpso import PSOAttack
...
ga_atttack = HHOAttack(model, word_candidate, dataset,
                       max_iter=20,
                       pop_size=pop_size)
...
for i in range(SAMPLE_SIZE):
    ...
    if x_adv is None:
        ...
        x_adv = ga_atttack.delete_optimization(x_orig, x_adv, target_label, pos_tags)
...
with open('result/AD_hho_sem_SST_BiLSTM_{}_{:.02f}%_{:.02f}%_{}s.pkl'
...
# with open('result2/AD_dhho_SST_BiLSTM_{}_{:.02f}%_{:.02f}%_{}s.pkl'
