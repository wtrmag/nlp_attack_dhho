...
if not os.path.exists('aux_files'):
    os.mkdir('aux_files')
dianping_dataset = data_utils.SSTDataset(path=PATH, max_vocab_size=MAX_VOCAB_SIZE)
...
glove_embeddings, _ = glove_utils.create_embeddings_matrix(glove_model, dianping_dataset.dict,
                                                           dianping_dataset.full_dict, d=300)
